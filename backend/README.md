...
## Project Structure
    ...
    ├── testapiautoteammemb_59393  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_59393`
...
2. Clone this repo and `cd testapiautoteammemb_59393`
